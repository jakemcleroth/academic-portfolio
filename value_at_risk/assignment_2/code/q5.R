...
library(readxl)
# Data
data <- as.data.frame(read_excel("/Users/jakemcleroth/Desktop/University/Masters/Modules/Semester 1/VaR/assignment/assignment_2/data/data_assignment_2.xlsx", sheet = "ALL"))

...
###### Data ######
data <- read_excel("/Users/jakemcleroth/Desktop/University/Masters/Modules/Semester 1/VaR/assignment/assignment_5/data/q2_3_4.xlsx")
...
data <- read_excel("/Users/jakemcleroth/Desktop/University/Masters/Modules/Semester 1/VaR/assignment/assignment_5/data/us_data_q2.xlsx")
data$Vol <- data$Vol*100
data <- data %>% mutate(
  index_returns = log(Index) - lag(log(Index), 1)
)

...
## Reference
Park, J.J. and Choe, G.H., 2016. A new variance reduction method for option pricing based on sampling the vertices of a simplex. _Quantitative Finance_, _16_(8), pp.1165-1173.

## Contents

| File                     | Description                    |
| ------------------------ | ------------------------------ |
| `stoch_sim_project.Rmd`  | R code                         |
| `stoch_sim_project.html` | Rendered write-up with figures |
